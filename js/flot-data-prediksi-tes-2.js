...
$(document).ready(function () {
  ...
  function getHum() {
    ...
    var yTemp = new Array();
    var url =
      "http://localhost/analisiskualitaskolamlele/Raspi06/api/ph.php";
    $.ajax({
      type: "GET",
      url: url,
      dataType: "json",
      ...
      success: function (response) {
        for (i = 0; i < response.records.length; i++) {
          ...
          yTemp[i] = parseInt(response.records[i].rataph);
        }
  ...
  function predictTemp(t, y) {
    ...
    document.getElementById("avgData2").innerHTML =
      "Mean Square Error : " + vAve / n;
    document.getElementById("avgN2").innerHTML = rl;
  }
});
