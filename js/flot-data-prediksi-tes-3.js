...
$(document).ready(function () {
  ...
  function getHum() {
    ...
    var yTemp = new Array();
    var url =
      "http://localhost/analisiskualitaskolamlele/Raspi06/api/amonia.php";
    $.ajax({
      type: "GET",
      url: url,
      dataType: "json",
      ...
      success: function (response) {
        for (i = 0; i < response.records.length; i++) {
          ...
          yTemp[i] = parseFloat(response.records[i].rataamonia);
        }
  ...
  function predictTemp(t, y) {
    ...
    document.getElementById("avgData3").innerHTML =
      "Mean Square Error : " + vAve / n;
    document.getElementById("avgN3").innerHTML = rl;
  }
});
